...
<html lang="en">
    ...
    <head>
        ...
        <meta name="title" content="{{ $title ? $title . ' - ' . config('app.name') : config('app.name') }}" />
    ...
    <body class="layout-fixed sidebar-expand-lg sidebar-open bg-body-tertiary">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex">
                                            ...
                                            <p
                                                class="ms-auto d-flex flex-column text-end"
                                            >
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            ...
                                            >
                                                <span class="fw-bold">
                                                    <i
                                                        class="bi bi-graph-up-arrow text-info"
                                                    ></i>
                                                    0.8%
                                                </span>
                                                <span class="text-secondary"
                                        ...
                                        >
                                            ...
                                            >
                                                <span class="fw-bold">
                                                    <i
                                                        class="bi bi-graph-down-arrow text-danger"
                                                    ></i>
                                                    1%
                                                </span>
                                                <span class="text-secondary"
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                // e.g., from ".{{ asset('dist') }}/css/adminlte.css", we get ".{{ asset('dist') }}/"
                // e.g., from "{{ asset('dist') }}/css/adminlte.css", we get "{{ asset('dist') }}/"
